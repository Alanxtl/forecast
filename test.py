...
from src.crawler.fetcher.developer import calc_developers_focuse_rate_on_repo, get_developer_s_all_commits_on_specific_repo, get_sliced_commits, get_sliced_commits_on_all_repos
...
if __name__ == "__main__":
    ...
    hertzbeat = repo("hertzbeat", "hertzbeat")
    hertzbeat.get_commit_data()

    print(get_sliced_commits_on_all_repos("tomsun28", hertzbeat.slice_rules))
